...
namespace FirstModelProject.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,PriceRon")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,PriceRon")] Movie movie)
        {
            if (ModelState.IsValid)
            {
